...
const tabs = [
  ...
  { href: '/import',   icon: 'ios_share',      label: 'Import' },
...
export default function BottomNav() {
  ...
  return (
    <nav className="fixed bottom-0 left-1/2 -translate-x-1/2 w-full max-w-[390px] z-50 flex justify-around items-center px-2 pb-8 pt-4 bg-[#131313]/60 backdrop-blur-xl shadow-[0_-4px_24px_rgba(0,0,0,0.4)]">
      {tabs.map(tab => {
